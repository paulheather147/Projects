...
class BinaryNode<T> implements BinaryNodeInterface<T>, java.io.Serializable
{
    ...
    public void preorderTraversal() {
        System.out.print(this.getData() + " "); // Visit the current node
        if (this.hasLeftChild()) {
            this.getLeftChild().preorderTraversal(); // Recursively traverse left subtree
        }
        if (this.hasRightChild()) {
            this.getRightChild().preorderTraversal(); // Recursively traverse right subtree
        }
    }
